...
require(rootSolve)
fb_mupsi_raw=findbetamupsi_raw(themean=0.20,thevariance = 0.05, thepsi=0.15,silent = TRUE)
...
source("~/GitHub/PriorGen-1/R/findbeta_plot.r")
require(rootSolve)
fb_mupsi_raw=findbetamupsi_raw(themean=0.20, thevariance = 0.1, thepsi=0.15,silent = TRUE)
par(mfrow=c(1,3))
...
findbeta_plot(fb_mupsi_raw,main="Elicited beta prior (Hierarchical prior top level)",
              ylab = "Density",lwd=3,type="l")
fb_mupsi_raw1=findbetamupsi_raw(themean=0.30, thevariance = 0.15, thepsi=0.15,silent = TRUE)
